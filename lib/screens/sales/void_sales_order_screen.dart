import 'package:bercaretailpos/screens/sales/void_sales_order_preview_screen.dart';
...
class VoidSalesOrderScreen extends StatefulWidget {
  final List user;

  VoidSalesOrderScreen({
    required this.user,
  });

  @override
  State<VoidSalesOrderScreen> createState() => _VoidSalesOrderScreenState();
}

class _VoidSalesOrderScreenState extends State<VoidSalesOrderScreen> {
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        ...
                                        Route route = MaterialPageRoute(
                                            builder: (context) => VoidSalesOrderPreviewScreen(
                                                user: widget.user,
