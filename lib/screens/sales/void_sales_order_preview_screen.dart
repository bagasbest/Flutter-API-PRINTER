...
class VoidSalesOrderPreviewScreen extends StatefulWidget {
  final List user;
  final List sendDataList;

  VoidSalesOrderPreviewScreen({required this.user, required this.sendDataList});

  @override
  State<VoidSalesOrderPreviewScreen> createState() => _VoidSalesOrderPreviewScreenState();
}

class _VoidSalesOrderPreviewScreenState extends State<VoidSalesOrderPreviewScreen> {
  ...
  void showCustomDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(
            "Void Sales Order ${widget.sendDataList[0]["salesOrderNumber"]}",
