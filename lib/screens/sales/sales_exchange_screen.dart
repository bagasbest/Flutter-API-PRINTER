...
import 'package:bercaretailpos/screens/sales/sales_exchange_preview_screen.dart';
...
class SalesExchangeScreen extends StatefulWidget {
  final List user;
  ...
  @override
  State<SalesExchangeScreen> createState() => _SalesExchangeScreenState();
}

class _SalesExchangeScreenState extends State<SalesExchangeScreen> {
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              ...
                                              Route route = MaterialPageRoute(
                                                  builder: (context) => SalesExchangePreviewScreen(
                                                    user: widget.user,
